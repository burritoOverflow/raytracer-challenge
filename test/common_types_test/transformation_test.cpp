...
TEST(TransformationTest, TestArbitraryViewTransformation) {
    ...
    const std::vector<double> first{-0.50709, 0.50709, 0.67612, -2.36643};
    const std::vector<double> second{0.76772, 0.60609, 0.12122, -2.82843};
    const std::vector<double> third{-0.35857, 0.59761, -0.71714, 0.0};
    const std::vector<double> fourth{0.0, 0.0, 0.0, 1.0};
    ...
    const size_t NUM_ROWS = expected_v.size();
